import os, sys
    os.system('reset')
print '\x1b[97mLogin Dlu Masukan ID dan Password'
print '\x1b[97mgk tau ya?? cek yt gw aja biar tau id pw'
print '\x1b[97mSilakan Login Login '
import os, sys
...
if sandi == 'AVATAR' and user == 'ID':
    print '\x1b[92mBerhasil Login'
    sys.exit
else:
    print '\x1b[91mSalah!!!'
    id()
